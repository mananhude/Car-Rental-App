...
public class Descriptionv5 extends AppCompatActivity implements PaymentResultListener {
    Button payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionv5);
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Descriptionv5.this,object);
