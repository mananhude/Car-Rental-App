...
public class Descriptionv1 extends AppCompatActivity implements PaymentResultListener {
    Button payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionv1);
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Descriptionv1.this,object);
