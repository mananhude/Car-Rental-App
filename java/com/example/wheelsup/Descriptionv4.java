...
public class Descriptionv4 extends AppCompatActivity implements PaymentResultListener {
    Button payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionv4);
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Descriptionv4.this,object);
