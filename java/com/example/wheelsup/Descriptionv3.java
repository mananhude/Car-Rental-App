...
public class Descriptionv3 extends AppCompatActivity implements PaymentResultListener {
    Button payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionv3);
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Descriptionv3.this,object);
