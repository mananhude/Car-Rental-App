...
public class Descriptionv2 extends AppCompatActivity implements PaymentResultListener {
    Button payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descriptionv2);
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(Descriptionv2.this,object);
